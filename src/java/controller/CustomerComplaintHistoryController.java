 ...
 * @author asus
 */
@WebServlet("/api/v1/customer/complaints")
public class CustomerComplaintHistoryController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            res.put("data", complaintDAO.getComplaintsByCustomerId(customerId));
        } catch (Exception e) {
