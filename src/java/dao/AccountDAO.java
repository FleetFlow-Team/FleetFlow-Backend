...
public class AccountDAO {
    ...
    private static final String INSERT_CUSTOMER = "INSERT INTO Customer (AccountID, Address, CreatedAt) VALUES (?, ?, ?)";
    ...
    public java.util.List<Integer> getActiveDispatcherAccountIds() throws Exception {
        java.util.List<Integer> ids = new java.util.ArrayList<>();
        String sql = "SELECT AccountID FROM Account "
                + "WHERE RoleName = 'Dispatcher' AND Status = 'ACTIVE' "
