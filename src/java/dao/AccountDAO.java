...
public class AccountDAO {
    ...
    private static final String ACCEPT_DRIVER_TERMS = "UPDATE Driver SET TermsAccepted  = 1, TermsAcceptedAt = ? WHERE AccountID = ?";
    ...
    private static final String GET_DRIVER_PROFILE
            ...
            + "       d.DriverID, d.ApprovalStatus, d.AvailabilityStatus, d.AverageRating, d.WalletBalance, d.TermsAccepted , "
            ...
            if (conn != null) {
                ...
                while (rs.next()) {
                    if (profile == null) {
                        ...
                        profile.put("termsAccepted", rs.getBoolean("TermsAccepted "));
